...
The Gaussian process prior helps define the uncertainty in the black-box function.  At each evaluated point, we squash the uncertainty (to zero if the function evaluation has no noise), which affects the expected value $\mu(x)$ and uncertainty $\sigma(x)$ at the remaining unknown points.
